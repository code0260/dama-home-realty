...
class TestimonialController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            // Cache testimonials for 2 hours (7200 seconds) - testimonials rarely change
            $cacheKey = 'testimonials.' . ($featured ? 'featured' : 'all') . '.' . $locale;
            $testimonials = Cache::remember($cacheKey, 7200, function () use ($query, $locale) {
