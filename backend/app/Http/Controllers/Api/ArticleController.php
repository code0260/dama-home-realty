...
class ArticleController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            // Cache articles for 1 hour (3600 seconds) - articles don't change frequently
            $cacheKey = 'articles.page.' . $request->get('page', 1) . '.per_page.' . $perPage . '.featured.' . ($request->boolean('featured') ? '1' : '0');
